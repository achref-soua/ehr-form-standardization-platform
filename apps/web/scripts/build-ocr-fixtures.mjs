...
</style></head><body><article class="frame"><div class="brand">EPICONCEPT <span class="tag">SMART HEALTH</span></div><h1>Compte rendu d’allergologie</h1><div class="label">Antécédents allergiques</div><div class="value">Allergie à la pénicilline avec urticaire.</div><div class="meta"><div class="field">Document : SYNTH-ALL-00482</div><div class="field">Date : 12/08/2026</div></div><div class="synthetic">SPÉCIMEN SYNTHÉTIQUE — AUCUNE DONNÉE PATIENT</div><div class="signature"><div>Signature (emplacement fictif)</div></div></article></body></html>`;
